 ...
 * do segundo grau, calcule e informe suas raizes reais,
...
int main(){
    ...
    printf("Informe os coeficientes da equacao\n\
            \rdo segundo grau na forma: ax^2+bx+c=0\n"
            );
    scanf("%f %f %f", &a, &b, &c);
    ...
    if (delta<0) \
        ...
        printf("As raizes da sua equacao sao:\n\
                \rx1 = %f\n\
                \rx2 = %f\n",
                raiz1,
                raiz2
        ...
        if (raiz1>0 && raiz2>0) \
            printf("Sua equacao poderia ser escrita como:\n\
                    \r(x-%f)*(x-%f)\n",
                    raiz1,
                    raiz2
                    );
        ...
        else printf("Sua equacao poderia ser escrita como:\n\
                \r(x-%f)*(x+%f)=0\n",
