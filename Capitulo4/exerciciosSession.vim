...
keepjumps 1
normal! 0
lcd ~/C_Slago/Capitulo4
wincmd w
argglobal
if bufexists(fnamemodify("~/C_Slago/Capitulo4/EX416_Func_Recur.c", ":p")) | buffer ~/C_Slago/Capitulo4/EX416_Func_Recur.c | else | edit ~/C_Slago/Capitulo4/EX416_Func_Recur.c | endif
balt ~/C_Slago/Capitulo4/EX415_aleat_time.c
setlocal fdm=indent
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
exe 'vert 2resize ' . ((&columns * 57 + 57) / 115)
tabnext
edit ~/C_Slago/Capitulo4/macros.h
let s:save_splitbelow = &splitbelow
let s:save_splitright = &splitright
set splitbelow splitright
wincmd _ | wincmd |
...
exe 'vert 2resize ' . ((&columns * 57 + 57) / 115)
argglobal
if bufexists(fnamemodify("~/C_Slago/Capitulo4/macros.h", ":p")) | buffer ~/C_Slago/Capitulo4/macros.h | else | edit ~/C_Slago/Capitulo4/macros.h | endif
setlocal fdm=indent
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
wincmd w
argglobal
if bufexists(fnamemodify("~/C_Slago/Capitulo4/boolean.h", ":p")) | buffer ~/C_Slago/Capitulo4/boolean.h | else | edit ~/C_Slago/Capitulo4/boolean.h | endif
setlocal fdm=indent
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
